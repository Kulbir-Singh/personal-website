...
export default function Nav() {
  ...
  return (
    <header className="z-50 w-full p-6 mt-6 bg-custom-green-100/50 rounded-3xl">
      <LazyMotion features={domAnimation}>
        ...
        >
          <button
            className="m-auto z-100 ml-4 absolute max-w-[1300px] w-full flex flex-col items-end top-[42px] mr-20 space-y-2 [&>div]:hover:scale-[2.5] [&>div]:hover:rotate-[0deg] even:[&>div]:-rotate-[45deg] [&>div]:duration-[2000ms] cursor-pointer"
            onClick={() => {
